...
router.get('/productreview/:id',verifyLogin.verifyLoginUser,userController.getreview)
router.post('/review/:id',verifyLogin.verifyLoginUser,userController.createReview)
